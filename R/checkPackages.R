...
#' @param add character: names of default packages to check (default: \code{c("shiny", "shinyWidgets", "shinydashboard", "shinydashboardPlus", "HKRbook")})
#'
...
checkPackages <- function(..., add=c("shiny", "shinyWidgets", "shinydashboard", "shinydashboardPlus", "HKRbook")) {
