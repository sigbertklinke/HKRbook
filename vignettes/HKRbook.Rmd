...
`HRKBook` these links has been replaced by functions `men_xxxx()`.
...
If you run the app then quit it by closing the app window.
...
`htmlTable` in connection with `toHTML` creates a HTML representation of a two-dimensional `table` object.

```{r, echo=FALSE}
par(mar=c(0,0,0,0))
plot(0,0, xlim=c(0,1), ylim=c(0,1), type="n", axes=FALSE)
#
rect(0, 0.8, 1, 1, border="black")
text(0.5, 0.9, "header line(s)")
#
rect(0, 0.7, 0.2, 0.8, border="black")
text(0.1, 0.75, "title")
#
rect(0.2, 0.7, 0.8, 0.8, border="black")
text(0.5, 0.75, "column names")
#
rect(0.8, 0.7, 1, 0.8, border="black")
text(0.9, 0.75, "rowmargin\ntitle")
#
rect(0, 0.3, 0.2, 0.8, border="black")
text(0.1, 0.5, "row names")
#
rect(0.8, 0.3, 1, 0.8, border="black")
text(0.9, 0.5, "row margin")
#
text(0.5, 0.5, "table")
#
rect(0, 0.2, 0.2, 0.3, border="black")
text(0.1, 0.25, "colmargin\ntitle")
#
rect(0.2, 0.2, 0.8, 0.3, border="black")
text(0.5, 0.25, "col margin")
#
rect(0.8, 0.2, 1, 0.3, border="black")
text(0.9, 0.25, "total")
#
rect(0, 0, 1, 0.2, border="black")
text(0.5, 0.1, "footer line(s)")
```
